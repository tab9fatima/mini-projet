        ...
        if($stmt = mysqli_prepare($con, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
					...
					$insert_data = "INSERT INTO studentnationality(cname2) VALUES ('$u_sport')";
...
<head>
	<title> Operation Nationalite</title>
	<meta charset="utf-8">
...
?>
		...
		<button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">
			<i class="fa fa-plus"></i> Ajouter nationalite
		</button>
		<hr>
		<table class="table table-bordered table-striped table-hover" id="myTable">
			<thead>
				<tr>
				<th class="text-center" scope="col">ID Nationalite </th>
        	...
        	$get_data = "SELECT * FROM studentnationality order by 1 asc";
...
<div id='$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <a href='deletenationaliti.php?id=$id' class='btn btn-danger' style='margin-left:250px'>Delete</a>
      </div>
    </div>
  </div>
</div>
